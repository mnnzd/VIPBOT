...
// Deja el array accesible globalmente si tu framework lo usa:
globalThis.chiste = globalThis.chiste || CHISTES

let handler = async (m, { conn }) => {
  try {
    const lista = globalThis.chiste || CHISTES
    if (!Array.isArray(lista) || lista.length === 0) {
      return m.reply('No hay chistes configurados.')
    }

    return m.reply(`*┏━━━━━━━━━━━┓*\n*😹 ${pickRandom(lista)} 😹*\n*┗━━━━━━━━━━━┛*`)
  } catch (e) {
    return m.reply('Error ejecutando el comando chiste.')
  }
}
